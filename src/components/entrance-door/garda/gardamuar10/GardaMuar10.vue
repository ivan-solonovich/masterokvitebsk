<template>
  <div class="entrance-door-details-wrapper">
    <BackToGarda/>
    <h2 class="entrance-door-details-title">ГАРДА МУАР 10 ММ</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ГАРДАМУАР10_1.webp" loading="lazy" alt="Гарда 10 мм">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ГАРДАМУАР10_2.webp" loading="lazy" alt="Гарда 10 мм">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ГАРДАМУАР8_3.webp" loading="lazy" alt="Гарда 10 мм">
    </div>
    <div class="entrance-door-series-content-container">
      <h6 class="door-series-desc" ><span>от</span> 658 руб</h6>
      <h6 class="door-series-desc" ><span></span>ГАРДА МУАР 10 ММ</h6>
    </div>
    <div class="entrance-door-details-description">
      <p>Входная дверь ГАРДА МУАР 10 ММ – один из лучших вариантов практичной и функциональной входной двери. В производстве
      ...
      <p>Часто хозяева предпочитают устанавливать ГАРДА МУАР 10 ММ в качестве входа в квартиру, ведь модель обладает
    ...
    <div class="entrance-door-details container">
      ...
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td>Венге тобакко, Белый ясень</td>
        </tr>
        <tr>
          <td>Размер</td>
          <td>860*2050</td>
