<template>
  <div class="entrance-door-details-wrapper">
    <BackToGarda/>
    <h2 class="entrance-door-details-title">ГАРДА 8 ВНУТРЕННЕЕ</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ГАРДА8ВНУТРЕННЕЕ_1.webp" loading="lazy" alt="ГАРДА 8 ВНУТРЕННЕЕ">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ГАРДА8ВНУТРЕННЕЕ_2.webp" loading="lazy" alt="ГАРДА 8 ВНУТРЕННЕЕ">
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь ГАРДА 8 ВНУТРЕННЕЕ – один из лучших вариантов практичной и функциональной входной двери. В производстве
      ...
      <p>Часто хозяева предпочитают устанавливать ГАРДА 8 ВНУТРЕННЕЕ в качестве входа в квартиру, ведь модель обладает
