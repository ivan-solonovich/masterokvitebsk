<template>
  <div class="armany">
    <BackToSeries/>
    <h1 class="armany-title">Стандарт 36</h1>
    <div class="container">
    ...
    <div class="container door-series-container">
      <div class="door-series">
        <img class="door-series-img" src="../../../assets/door-inside/door-series/standart_36/C36_beldyb.png" alt="">
        <h6 class="door-series-desc" ><span>Цвет:</span> Беленый дуб></h6>
        <h6 class="door-series-desc" ><span>Стекло:</span> Матовое</h6>
      </div>

      <div class="door-series">
        <img class="door-series-img" src="../../../assets/door-inside/door-series/standart_36/C36_ital.png" alt="">
        <h6 class="door-series-desc" ><span>Цвет:</span> Итальянский орех</h6>
        <h6 class="door-series-desc" ><span>Стекло:</span> Матовое</h6>
      </div>

      <div class="door-series">
        <img class="door-series-img" src="../../../assets/door-inside/door-series/standart_36/C36_milan.png" alt="">
        <h6 class="door-series-desc" ><span>Цвет:</span> Миланский орех</h6>
        <h6 class="door-series-desc" ><span>Стекло:</span>  Матовое</h6>
      </div>

      <div class="door-series">
        <img class="door-series-img" src="../../../assets/door-inside/door-series/standart_36/C36_venge.png" alt="">
