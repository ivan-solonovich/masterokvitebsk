<template>
  <div class="entrance-door-details-wrapper">
    <BackToGarda/>
    <h2 class="entrance-door-details-title">ГАРДА ЧИКАГО NEW</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ЧИКАГОNEW_1.webp" loading="lazy" alt="ГАРДА ЧИКАГО NEW">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ЧИКАГОNEW_2.webp" loading="lazy" alt="ГАРДА ЧИКАГО NEW">
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь ГАРДА ЧИКАГО NEW – один из лучших вариантов практичной и функциональной входной двери. В производстве
      ...
      <p>Часто хозяева предпочитают устанавливать ГАРДА ЧИКАГО NEW в качестве входа в квартиру, ведь модель обладает
