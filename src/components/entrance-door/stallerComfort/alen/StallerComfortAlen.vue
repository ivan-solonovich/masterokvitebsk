<template>
  <div class="entrance-door-details-wrapper">
    ...
    <h2 class="entrance-door-details-title">СТАЛЛЕР КОМФОРТ АЛЕН</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller-comfort/bavaria_1.webp" loading="lazy" alt="СТАЛЛЕР КОМФОРТ АЛЕН">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller-comfort/bavaria_2.webp" loading="lazy" alt="СТАЛЛЕР КОМФОРТ АЛЕН">
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь СТАЛЛЕР КОМФОРТ АЛЕН – один из лучших вариантов практичной и функциональной входной двери. В производстве
      ...
      <p>Ключевая особенность модели атмосферостойкое покрытие. Порошково-полимерный состав наружной стороны устойчив
        ...
        СТАЛЛЕР КОМФОРТ АЛЕН можно устанавливать в дома с прямым выходом на улицу. Это могут быть загородные частные дома,
        летние дачи, офисы и склады.</p>
      <p>Часто хозяева предпочитают устанавливать СТАЛЛЕР КОМФОРТ АЛЕН в качестве входа в квартиру, ведь модель обладает
