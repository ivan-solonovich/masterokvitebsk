<template>
  <div class="entrance-door-details-wrapper">
    <BackToStaller/>
    <h2 class="entrance-door-details-title">СТАЛЛЕР БЕТОЛЛА</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller/betolla_1.webp" loading="lazy" alt="СТАЛЛЕР БЕТОЛЛА">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller/betolla_2.webp" loading="lazy" alt="СТАЛЛЕР БЕТОЛЛА">
    ...
    <div class="entrance-door-details-description">
      <p>Металлический каркас входной двери «БЕТОЛЛА» имеет толщину 1,5 мм, такая толщина металла гарантирует высокую
      ...
      <p>Выигрышные особенности двери «БЕТОЛЛА»:</p>
