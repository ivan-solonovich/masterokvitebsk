<template>
  <div class="entrance-door-details-wrapper">
    <BackToStaller/>
    <h2 class="entrance-door-details-title">СТАЛЛЕР СТИЛО 2</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller/stillo2_1.webp" loading="lazy" alt="СТАЛЛЕР СТИЛО 2">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller/stillo2_2.webp" loading="lazy" alt="СТАЛЛЕР СТИЛО 2">
