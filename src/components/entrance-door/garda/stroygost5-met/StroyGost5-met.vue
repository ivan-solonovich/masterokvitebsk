<template>
  <div class="entrance-door-details-wrapper">
    <BackToGarda/>
    <h2 class="entrance-door-details-title">ГАРДА СТРОЙГОСТ 5 РФ Металл/Металл</h2>
    <div class="entrance-door-series-img-container">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/stroygost5-met_1.jpg" loading="lazy" alt="Входные двери Гарда СТРОЙГОСТ 5 РФ">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/stroygost5-met_2.jpg" loading="lazy" alt="Входные двери Гарда СТРОЙГОСТ 5 РФ">
    </div>
