<template>
  <div class="entrance-door-details-wrapper">
    <BackToStaller/>
    <h2 class="entrance-door-details-title">СТАЛЛЕР АЛЬБА</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller/alba_1.webp" loading="lazy" alt="СТАЛЛЕР АЛЬБА">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller/alba_2.webp" loading="lazy" alt="СТАЛЛЕР АЛЬБА">
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь СТАЛЛЕР АЛЬБА – один из лучших вариантов практичной и функциональной входной двери. В производстве
      ...
      <p>Часто хозяева предпочитают устанавливать СТАЛЛЕР АЛЬБА в качестве входа в квартиру, ведь модель обладает
