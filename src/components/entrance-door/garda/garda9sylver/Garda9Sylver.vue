<template>
  <div class="entrance-door-details-wrapper">
    <BackToGarda/>
    <h2 class="entrance-door-details-title">ГАРДА 9 СЕРЕБРО ЦАРГА</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ГАРДА9СЕРЕБРО_1.webp" loading="lazy" alt="ГАРДА 9 СЕРЕБРО ЦАРГА">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ГАРДА9СЕРЕБРО_2.webp" loading="lazy" alt="ГАРДА 9 СЕРЕБРО ЦАРГА">
      <img class="door-series-img" src="../../../../assets/entrance-door/garda/ГАРДА9СЕРЕБРО_3.webp" loading="lazy" alt="ГАРДА 9 СЕРЕБРО ЦАРГА">
    </div>
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь ГАРДА 9 СЕРЕБРО ЦАРГА – один из лучших вариантов практичной и функциональной входной двери. В производстве
      ...
      <p>Часто хозяева предпочитают устанавливать ГАРДА 9 СЕРЕБРО ЦАРГА в качестве входа в квартиру, ведь модель обладает
    ...
    <div class="entrance-door-details container">
      ...
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td>Бетон снежный, Лиственница беж.</td>
        </tr>
        <tr>
          <td>Размер</td>
          <td>860*2050</td>
