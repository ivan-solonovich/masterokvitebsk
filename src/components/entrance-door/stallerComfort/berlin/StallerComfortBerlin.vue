<template>
  <div class="entrance-door-details-wrapper">
    ...
    <h2 class="entrance-door-details-title">СТАЛЛЕР КОМФОРТ БЕРЛИН</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller-comfort/berlin_1.webp" loading="lazy" alt="СТАЛЛЕР КОМФОРТ БЕРЛИН">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller-comfort/berlin_2.webp" loading="lazy" alt="СТАЛЛЕР КОМФОРТ БЕРЛИН">
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь СТАЛЛЕР КОМФОРТ БЕРЛИН – один из лучших вариантов практичной и функциональной входной двери. В производстве
        используются надежные материалы, изделие хорошо подходит для белорусского климата.</p>

      <p>Часто хозяева предпочитают устанавливать СТАЛЛЕР КОМФОРТ БЕРЛИН в качестве входа в квартиру, ведь модель обладает
