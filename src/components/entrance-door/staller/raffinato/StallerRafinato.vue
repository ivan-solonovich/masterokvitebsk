<template>
  <div class="entrance-door-details-wrapper">
    <BackToStaller/>
    <h2 class="entrance-door-details-title">СТАЛЛЕР РАФФИНАТО</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller/РАФФИНАТО_1.webp" loading="lazy" alt="СТАЛЛЕР РАФФИНАТО">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller/РАФФИНАТО_2.webp" loading="lazy" alt="СТАЛЛЕР РАФФИНАТО">
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь СТАЛЛЕР РАФФИНАТО – один из лучших вариантов практичной и функциональной входной двери. В производстве
      ...
      <p>Часто хозяева предпочитают устанавливать СТАЛЛЕР РАФФИНАТО в качестве входа в квартиру, ведь модель обладает
