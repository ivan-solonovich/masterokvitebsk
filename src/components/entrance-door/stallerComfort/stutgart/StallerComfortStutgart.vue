<template>
  <div class="entrance-door-details-wrapper">
    ...
    <h2 class="entrance-door-details-title">СТАЛЛЕР КОМФОРТ ШТУТГАРТ</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller-comfort/stutgart_1.webp" loading="lazy" alt="СТАЛЛЕР КОМФОРТ ШТУТГАРТ">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller-comfort/stutgart_2.webp" loading="lazy" alt="СТАЛЛЕР КОМФОРТ ШТУТГАРТ">
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь СТАЛЛЕР КОМФОРТ ШТУТГАРТ – один из лучших вариантов практичной и функциональной входной двери. В производстве
        используются надежные материалы, изделие хорошо подходит для белорусского климата.</p>

      <p>Часто хозяева предпочитают устанавливать СТАЛЛЕР КОМФОРТ ШТУТГАРТ в качестве входа в квартиру, ведь модель обладает
