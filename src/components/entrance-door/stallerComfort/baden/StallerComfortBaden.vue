<template>
  <div class="entrance-door-details-wrapper">
    ...
    <h2 class="entrance-door-details-title">СТАЛЛЕР КОМФОРТ БАДЕН</h2>
    <div class="entrance-door-series-img-container" style="flex-wrap: wrap">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller-comfort/baden_1.webp" loading="lazy" alt="СТАЛЛЕР КОМФОРТ БАДЕН">
      <img class="door-series-img" src="../../../../assets/entrance-door/staller-comfort/baden_2.webp" loading="lazy" alt="СТАЛЛЕР КОМФОРТ БАДЕН">
    ...
    <div class="entrance-door-details-description">
      <p>Входная дверь СТАЛЛЕР КОМФОРТ БАДЕН – один из лучших вариантов практичной и функциональной входной двери. В производстве
      ...
      <p>Ключевая особенность модели атмосферостойкое покрытие. Порошково-полимерный состав наружной стороны устойчив
        ...
        СТАЛЛЕР КОМФОРТ БАДЕН можно устанавливать в дома с прямым выходом на улицу. Это могут быть загородные частные дома,
        летние дачи, офисы и склады.</p>
      <p>Часто хозяева предпочитают устанавливать СТАЛЛЕР КОМФОРТ БАДЕН в качестве входа в квартиру, ведь модель обладает
